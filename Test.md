...
Calculate volatility over entire length of series for the different
decay factors
...
Examination shows the greatest one year difference to occur in the final
...
![](Problems_files/figure-markdown_strict/unnamed-chunk-15-1.png)
